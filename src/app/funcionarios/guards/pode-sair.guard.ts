...
export class PodeSairGuard implements CanDeactivate<FuncionarioComponent> {
 ...
 constructor (
  ...
  canDeactivate(
    ...
    currentRoute: ActivatedRouteSnapshot, // apartir dele conseguimos acessar o valor dos parametros
    currentState: RouterStateSnapshot,
    nextState?: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
     // se o guard retornar o valot TRUE, significa que a pessoa pode sair da página
     // se o guard reornar o valor FALSE,significa que a pessoa NÃO PODE sair da página

     // 1 passo pegar os dados do formulário e guardar cada um em variáveis diferentes.
